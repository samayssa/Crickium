"""
Layout coordinates for the Bronze tier player card template
(card_coordinates/bronze.py).
...
CAPTAIN_ROW = {
    ...
    "value_box": (376, 410, 635, 491),   # where the captain's name goes
    "value_center_y": 431,
}
...
FRANCHISE_ROW = {
    ...
    "value_box": (376, 486, 635, 557),   # where the franchise name goes
    "value_center_y": 501,
}
410
# --- SQUAD row ---
SQUAD_ROW = {
    ...
    "value_box": (445, 547, 685, 619),   # where th "{count}/25" goes
    "value_center_y": 573,
}
