...
from app import app
from database.playint_repo import get_match,set_message_id,set_toss,set_decision
from utils.mentions import mention_html
from buttons.playint_buttons import toss_call_keyboard,decision_keyboard
...
@register_callback('playint_toss_call')
async def playint_toss_call(callback_query):
...
@register_callback('playint_decision')
async def playint_decision(callback_query):
